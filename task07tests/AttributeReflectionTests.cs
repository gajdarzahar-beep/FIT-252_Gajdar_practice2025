...
public class AttributeReflectionTests
{
    ...
    public void PrintTypeInfo_ReturnsCorrectInfo()
    {
        ...
        Assert.Contains("Class DisplayName: Пример класса", result);
        Assert.Contains("Version: 1.0", result);
        Assert.Contains("TestMethod - DisplayName: Тестовый метод", result);
        Assert.Contains("Number - DisplayName: Числовое свойство", result);
    }
}
